  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose React Univerisity ?</h2>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className="text-center">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto perspiciatis sunt ipsum voluptatem a nihil. Aut, autem fugiat sit libero tempora quas. Eum excepturi maxime recusandae inventore similique deserunt sapiente!
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
